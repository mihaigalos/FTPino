...
typedef enum TE_FTPClient_WriteMode {
  ...
  TE_FTPClient_WriteMode_Overwrite // creates a new file and writes to it. If
                                   // file already exists, it gets deleted and
...
public:
  ...
  String send(String &stringToWrite, String &remoteFile,
              TE_FTPClient_WriteMode writeMode = TE_FTPClient_WriteMode_Append);
  void onFail();
};
#endif // CLIENT_ACTIVE
